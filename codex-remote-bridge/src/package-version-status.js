...
// Purpose: Reads the installed Codex Remote package version and caches the latest published npm version.
// Layer: CLI helper
...
const CODEX_REMOTE_REGISTRY_URL = "https://registry.npmjs.org/codex-remote/latest";
...
function createBridgePackageVersionStatusReader({
  ...
  registryUrl = CODEX_REMOTE_REGISTRY_URL,
