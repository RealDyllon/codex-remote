...
struct QRScannerView: View {
        ...
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                if let command = prompt.command, !command.isEmpty {
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Codex Remote", detail: command, showsCopyButton: true)
                    bridgeUpdateStep(number: "2", title: "Start it again", detail: "Run codex-remote up")
                    ...
                    bridgeUpdateStep(number: "1", title: "Update Codex Remote", detail: "Install the latest Codex Remote build on this iPhone.")
    ...
    private var scannerOverlay: some View {
        VStack(spacing: 24) {
            ...
            Text("Scan the Codex Remote QR code")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        title: "Update Codex Remote on your computer before scanning",
        message: "This QR code was generated by a different Codex Remote npm version. Update the package on your computer to the latest release before scanning a new QR code.",
...
private final class QRCameraLifecycleCoordinator {
    ...
    private let queue = DispatchQueue(label: "com.codexremote.qr-camera.lifecycle")
