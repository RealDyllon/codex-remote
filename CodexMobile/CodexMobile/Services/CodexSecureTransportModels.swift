...
// Purpose: Defines the wire payloads, device trust records, and crypto helpers for Codex Remote E2EE.
...
let codexSecureHandshakeTag = "codex-remote-e2ee-v1"
let codexSecureHandshakeLabel = "client-auth"
let codexSecureClockSkewToleranceSeconds: TimeInterval = 60
let codexTrustedSessionResolveTag = "codex-remote-trusted-session-resolve-v1"
...
enum CodexSecureTransportError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .invalidQR(let message),
            ...
            return message
        case .decryptFailed:
            return "Unable to decrypt the secure Codex Remote payload."
        }
    }
}
