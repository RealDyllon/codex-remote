// FILE: relay.js
// Purpose: Thin self-hostable WebSocket relay for Codex Remote pairing, trusted-session lookup, and encrypted forwarding.
...
const TRUSTED_SESSION_RESOLVE_TAG = "codex-remote-trusted-session-resolve-v1";
